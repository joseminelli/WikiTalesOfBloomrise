...
<div class="recipe-filters">
  <button class="filter-btn active" onclick="filterRecipes('all')">Tudo</button>
  <button class="filter-btn" onclick="filterRecipes('consumables_hp')">Culinária (HP)</button>
  <button class="filter-btn" onclick="filterRecipes('consumables_energy')">Culinária (Energia)</button>
  <button class="filter-btn" onclick="filterRecipes('equipment')">Equipamentos</button>
  <button class="filter-btn" onclick="filterRecipes('materials')">Materiais</button>
</div>

<div id="recipes-master-list">
<div class="recipe-category-section" data-cat="consumables_hp">
<h2> Consumíveis — Vida
</h2>
...
<div class="recipe-card-full" data-category="consumables_hp">
    ...
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Batata">
            <img src="/assets/items/batata.png">
            <span>2</span>
        </div>
    </div>
</div>
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/batatafrita.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/batatafrita/">Batata Frita</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Batata">
...
<div class="recipe-card-full" data-category="consumables_hp">
    ...
    <div class="recipe-ingredients-list">
        ...
        <div class="ing-item" title="Cenoura">
            <img src="/assets/items/cenoura.png">
            <span>2</span>
        </div>
    </div>
</div>
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/donutsmistico.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/donutsmistico/">Donut Místico</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Trigo">
...
<div class="recipe-card-full" data-category="consumables_hp">
    ...
    <div class="recipe-ingredients-list">
        ...
        <div class="ing-item" title="Chub">
            <img src="/assets/items/chub.png">
            <span>1</span>
        </div>
        <div class="ing-item" title="Batata">
            <img src="/assets/items/batata.png">
...
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/geleiamorango.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/geleiamorango/">Geleia de Morango</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
...
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/pipoca.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/pipoca/">Pipoca</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Milho">
            <img src="/assets/items/corn.png">
            <span>2</span>
        </div>
    </div>
</div>
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/pao.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/pao/">Pão</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Trigo">
...
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/paodebatata.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/paodebatata/">Pão de Batata</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Trigo">
...
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/sanduiche.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/sanduiche/">Sanduíche</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Pão">
            <img src="/assets/items/pao.png">
            <span>1</span>
        </div>
        <div class="ing-item" title="Nabo">
            <img src="/assets/items/turnip.png">
        ...
        <div class="ing-item" title="Tomate">
            <img src="/assets/items/tomato.png">
            <span>2</span>
        </div>
        <div class="ing-item" title="Cebola">
            <img src="/assets/items/cebola.png">
            <span>1</span>
        </div>
    </div>
</div>
...
<div class="recipe-card-full" data-category="consumables_hp">
    ...
    <div class="recipe-ingredients-list">
        ...
        <div class="ing-item" title="Abóbora">
            <img src="/assets/items/abobora.png">
            <span>2</span>
        </div>
    </div>
</div>
...
<div class="recipe-card-full" data-category="consumables_hp">
    <div class="recipe-header">
        <img src="/assets/items/tortaabobora.png" class="mini-icon">
        <strong><a href=".././consumables_hp/_items/tortaabobora/">Torta de Abóbora</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Trigo">
...
<div class="recipe-category-section" data-cat="consumables_energy">
<h2> Consumíveis — Energia
</h2>
<div class="recipes-container">

<div class="recipe-card-full" data-category="consumables_energy">
    <div class="recipe-header">
        <img src="/assets/items/sucouva.png" class="mini-icon">
        <strong><a href=".././consumables_energy/_items/sucouva/">Suco de Uva</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Uva">
            <img src="/assets/items/grape.png">
            <span>2</span>
        </div>
    </div>
</div>
<div class="recipe-card-full" data-category="consumables_energy">
    <div class="recipe-header">
        <img src="/assets/items/vinho.png" class="mini-icon">
        <strong><a href=".././consumables_energy/_items/vinho/">Vinho</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Uva">
...
<div class="recipe-category-section" data-cat="materials">
<h2> Materiais e Itens Gerais
</h2>
<div class="recipes-container">
...
<div class="recipe-card-full" data-category="materials">
    ...
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Corda">
            <img src="/assets/items/corda.png">
            <span>2</span>
        </div>
...
<div class="recipe-card-full" data-category="materials">
    <div class="recipe-header">
        <img src="/assets/items/corda.png" class="mini-icon">
        <strong><a href=".././materials/_items/corda/">Corda</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
...
<div class="recipe-card-full" data-category="materials">
    <div class="recipe-header">
        <img src="/assets/items/madeirarefinada.png" class="mini-icon">
        <strong><a href=".././materials/_items/madeirarefinada/">Madeira Refinada</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Tronco de Madeira">
...
<div class="recipe-card-full" data-category="materials">
    ...
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Girassol">
            <img src="/assets/items/sunflower.png">
            <span>2</span>
        </div>
    </div>
</div>
...
<div class="recipe-category-section" data-cat="equipment">
<h2> Equipamentos
</h2>
<div class="recipes-container">
...
<div class="recipe-card-full" data-category="equipment">
    ...
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Madeira Refinada">
            <img src="/assets/items/madeirarefinada.png">
            <span>2</span>
        </div>
        <div class="ing-item" title="Barra de Ferro">
            <img src="/assets/items/ferro.png">
...
<div class="recipe-card-full" data-category="equipment">
    <div class="recipe-header">
        <img src="/assets/items/wood-axe.png" class="mini-icon">
        <strong><a href=".././equipment/_items/wood-axe/">Machado de Madeira</a></strong>
        <span class="yield-badge">x1</span>
    </div>
    <div class="recipe-ingredients-list">
        <div class="ing-item" title="Madeira Refinada">
...
<div class="recipe-category-section" data-cat="placeable">
<h2> Itens Posicionáveis
</h2>
<div class="recipes-container">

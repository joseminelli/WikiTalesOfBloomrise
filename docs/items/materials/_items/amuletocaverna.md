...
<div class="item-section crafting"><h2>🔨 Como Criar</h2><div class="recipe-box"><p>Rende: <strong>1x</strong></p><ul><li><img src="/assets/items/corda.png" class="mini-icon"> 2x <a href="/items/materials/_items/corda/">Corda</a></li><li><img src="/assets/items/ferro.png" class="mini-icon"> 1x <a href="/items/materials/_items/ferro/">Barra de Ferro</a></li></ul></div></div></div>
...
<div class="item-header">
   ...
   <div class="item-info">
     <h1 class="item-title">Sardinha Grelhada</h1>
...
<div class="item-section"><h2>🔨 Como Criar</h2><p class="yield-text" style="margin-bottom: 0.5rem; font-size: 0.9rem; opacity: 0.8;">Rende: <strong>1x</strong></p><div class="used-grid">
    <a href="/items/materials/_items/sardinha/" class="mini-card">
        <img src="/assets/items/Sardinha.png" alt="Sardinha">
        <span>1x Sardinha</span>
    </a></div></div></div>
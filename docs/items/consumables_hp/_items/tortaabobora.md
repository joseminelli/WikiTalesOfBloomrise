...
<div class="item-header">
   ...
   <div class="item-info">
     <h1 class="item-title">Torta de Abóbora</h1>
...
<div class="item-section"><h2>🔨 Como Criar</h2><p class="yield-text" style="margin-bottom: 0.5rem; font-size: 0.9rem; opacity: 0.8;">Rende: <strong>1x</strong></p><div class="used-grid">
    ...
    <a href="/items/materials/_items/abobora/" class="mini-card">
        <img src="/assets/items/abobora.png" alt="Abóbora">
        <span>2x Abóbora</span>
    </a></div></div></div>
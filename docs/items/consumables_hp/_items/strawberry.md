...
<div class="item-section"><h2>✨ Efeitos</h2><ul><li>❤️ Vida +3.0</li></ul></div><div class="item-section used-in"><h2>🛠️ Usado para criar</h2><div class="used-grid"><a href="/items/consumables_hp/_items/geleiamorango/" class="mini-card"><img src="/assets/items/geleiamorango.png"><span>Geleia de Morango</span></a></div></div></div>
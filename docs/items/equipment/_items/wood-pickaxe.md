...
<div class="item-section crafting"><h2>🔨 Como Criar</h2><div class="recipe-box"><p>Rende: <strong>1x</strong></p><ul><li><img src="/assets/items/madeirarefinada.png" class="mini-icon"> 5x <a href="/items/materials/_items/madeirarefinada/">Madeira Refinada</a></li><li><img src="/assets/items/woodlog.png" class="mini-icon"> 2x <a href="/items/materials/_items/woodlog/">Tronco de Madeira</a></li></ul></div></div></div>